    ...
    if (!$('.footer')) document.body.insertAdjacentHTML('beforeend', `
      <footer class="footer">
        <div class="f-grid">
          ...
          <div><h4>Navigate</h4>${NAV.map(([h, t]) => `<a href="${h}">${t}</a>`).join('')}<a href="store.html#track">Track order</a></div>
          <div><h4>Services</h4><a href="quote.html">Custom prints</a><a href="quote.html">Design & CAD</a><a href="quote.html">Batch production</a><a href="showcase.html">Case studies</a></div>
